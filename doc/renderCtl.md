...
/satie/rendererCtl setOrientationDeg  azimuthOffset elevationOffset  // to offset the renderer's listener orientation  (nb. only effects panning);   +azimuthOffset == Clockwise, -azimuthOffset == counterClockwise
